# Legacy Engineering Roadmap

This document preserves the previous `docs/ROADMAP.md` for historical context. It is **not** the canonical current product roadmap.

For current product direction, read `docs/ACL_MASTER_ROADMAP.md`.
