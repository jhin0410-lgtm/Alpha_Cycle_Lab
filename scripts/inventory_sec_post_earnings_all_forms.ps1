...
$DefaultOutput = Join-Path $RepositoryRoot "data/private/research/sec-post-earnings-all-form-inventory"
...
Write-Host "Inventorying official SK hynix SEC primary HTML filings across all forms after $AfterDate."
Write-Host "Python: $ProjectPython"
& $ProjectPython -m alpha_cycle.sec_post_earnings_all_form_inventory_cli `
