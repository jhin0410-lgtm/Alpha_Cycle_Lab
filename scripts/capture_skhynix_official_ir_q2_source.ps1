...
Write-Host "[1/2] Resolving the official SK hynix IR transport and capturing /board/list."
...
if ($LASTEXITCODE -ne 0) {
    Write-Error "SK hynix board API stage did not resolve/capture safely; PDF stage was not attempted."
    exit $LASTEXITCODE
}

Write-Host "[2/2] Capturing the returned 2Q26 Earnings Release PDF from cdnUrl + fileUrl2."
